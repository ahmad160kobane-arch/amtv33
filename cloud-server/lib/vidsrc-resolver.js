...
function buildEmbedUrls(tmdbId, imdbId, type, season, episode) {
  ...
  // المصدر الاحتياطي 5: autoembed.cc
  sources.push({
    name: 'autoembed.cc',
    url: isTv
  ...
  // المصدر الاحتياطي 6: multiembed.mov (يدعم imdb)
  if (imdbId) {
    sources.push({
      name: 'multiembed.mov',
      url: isTv
